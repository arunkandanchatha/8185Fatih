...
*     ..
*     .. Array Arguments ..
      REAL(kind=8)       WK(3,NXD,NYD),XD(NXD),XI(NIP),YD(NYD),YI(NIP),
     +                 ZD(NXD,NYD),ZI(NIP)
*     ..
*     .. Local Scalars ..
...
*     ..
*     .. Array Arguments ..
      REAL(kind=8)       WK(3,NXD,NYD),XD(NXD),XI(NXI),YD(NYD),YI(NYI),
...
* Calculates the z values at the output-grid points.
              CALL RGPLNL(NXD,NYD,XD,YD,ZD,WK,NIPI,XI(IXI),YII,INXI,
     +                    INYI, ZI(IXI,IYI))
*             CALL RGPLNL(NXD,NYD,XD,YD,ZD,PDD,NIP,XI,YI,INXI,INYI, ZI)
   40     CONTINUE
   50 CONTINUE
...
*     ..
*     .. Array Arguments ..
      REAL(kind=8)     PDD(3,NXD,NYD),XD(NXD),YD(NYD),ZD(NXD,NYD)
*     ..
*     .. Local Scalars ..
      REAL(kind=8)       B00,B00X,B00Y,B01,B10,B11,CX1,CX2,CX3,CY1,CY2,
...
*     ..
*     .. Local Arrays ..
      REAL(kind=8)     B00XA(4),B00YA(4),B01A(4),B10A(4),CXA(3,4),
...
*     ..
*     .. Array Arguments ..
      REAL(kind=8)             XD(NXD),XI(NIP),YD(NYD),YI(NIP)
...
*     ..
*     .. Array Arguments ..
      REAL(kind=8)       PDD(3,NXD,NYD),XD(NXD),XI(NIP),YD(NYD),YI(NIP),
     +                 ZD(NXD,NYD),ZI(NIP)
      INTEGER          INXI(NIP),INYI(NIP)
*     ..
*     .. Local Scalars ..
      REAL(kind=8)      A,B,C,D,DX,DXSQ,DY,DYSQ,P00,P01,P02,P03,P10,P11,
